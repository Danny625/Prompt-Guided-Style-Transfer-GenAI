python3 ./train.py \
    ...
    --output_dir /home/ec2-user/GenAI-Project/model/decouple_dit_outputs/hptune_test/frozen \
    --resolution 256 \
    --batch_size 4 \
    --lr 1e-5 \
    --weight_decay 1e-2 \
    ...
    --num_sample_images 2 \
    --mixed_precision no \
    --seed 42 --freeze_text_encoder --freeze_vae --use_dit --model_type decouple --use_advanced_loss
